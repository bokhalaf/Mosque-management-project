// ==============================
// Donations — DonationDebugBox Component
// صندوق طباعة ومراقبة رد السيرفر وطلبات الـ API المباشرة
// ==============================

import React, { useState } from 'react';
import { Terminal, X, Copy, Check } from 'lucide-react';
import { ApiDebugLog } from '../../../hooks/useDonations';

interface DonationDebugBoxProps {
  debugLogs: ApiDebugLog[];
  onClear: () => void;
  onClose: () => void;
}

export function DonationDebugBox({ debugLogs, onClear, onClose }: DonationDebugBoxProps) {
      ...
      <div className="flex items-center justify-between border-b border-slate-800 pb-3">
        <div className="flex items-center gap-2.5">
          ...
          <h4 className="text-xs font-black text-slate-200 tracking-wide font-mono dir-ltr">
            LIVE API INSPECTOR — HTTP REQUEST LOGS
          </h4>
        </div>
