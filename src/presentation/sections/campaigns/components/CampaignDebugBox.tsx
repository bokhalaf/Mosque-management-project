// ==============================
// Campaigns — CampaignDebugBox Component
// صندوق طباعة ومراقبة رد السيرفر وطلبات الـ API المباشرة للحملات
// ==============================

import React, { useState } from 'react';
import { X, Copy, Check } from 'lucide-react';
import { ApiDebugLog } from '../../../hooks/useCampaigns';

interface CampaignDebugBoxProps {
  debugLogs: ApiDebugLog[];
  onClear: () => void;
  onClose: () => void;
}

export function CampaignDebugBox({ debugLogs, onClear, onClose }: CampaignDebugBoxProps) {
      ...
      <div className="flex items-center justify-between border-b border-slate-800 pb-3">
        <div className="flex items-center gap-2.5">
          ...
          <h4 className="text-xs font-black text-slate-200 tracking-wide font-mono dir-ltr">
            LIVE CAMPAIGNS API INSPECTOR — HTTP LOGS
          </h4>
        </div>
